...
export interface ApiBlogContentBlogContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    future_article: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
...
export interface ApiFacultySectionFacultySection
  ...
  info: {
    ...
    pluralName: 'faculty-sections';
    singularName: 'faculty-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::faculty-section.faculty-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiHeroSectionHeroSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'One entry per page: pageSlug matches your frontend route key; heroVariant selects which hero component renders.';
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    careerRoles: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
